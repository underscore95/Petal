...
namespace Petal {
    ...
    const VkInstance &RenderingSystem::GetInstance() const {
        return m_instance;
    }
    ...
    VkValidationFeaturesEXT RenderingSystem::CreateValidationFeatures(
    ...
    VkApplicationInfo RenderingSystem::CreateApplicationInfo() const {
        return {
    ...
    VkInstanceCreateInfo RenderingSystem::CreateInstanceCreateInfo(
   ...
   return         "VK_KHR_xcb_surface";
    ...
    std::vector<const char *> RenderingSystem::GetExtensionNames() {
        return {
    ...
    std::vector<const char *> RenderingSystem::GetLayerNames() {
        return {
#ifndef NDEBUG
    ...
    Result RenderingSystem::CreateDebugCallback() {
    ...
    VkBool32 RenderingSystem::DebugCallbackStatic(
        VkDebugUtilsMessageSeverityFlagBitsEXT severity,
        VkDebugUtilsMessageTypeFlagsEXT type,
        const VkDebugUtilsMessengerCallbackDataEXT *pCallbackData,
        void *pUserData
    ) {
        auto renderingSystem = static_cast<RenderingSystem *>(pUserData);
        assert(renderingSystem);

        return renderingSystem->DebugCallback(severity, type, pCallbackData);
    }

    VkBool32 RenderingSystem::DebugCallback(
        VkDebugUtilsMessageSeverityFlagBitsEXT severity,
        VkDebugUtilsMessageTypeFlagsEXT type,
        const VkDebugUtilsMessengerCallbackDataEXT *pCallbackData
    ) const {
    ...
    VkDebugUtilsMessengerCreateInfoEXT RenderingSystem::CreateDebugMessengerCreateInfo() {
        return {
    ...
    void RenderingSystem::DestroyDebugMessenger() const {
